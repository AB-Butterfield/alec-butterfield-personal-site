...
export default[
    ...
    },
    {
        ...
        description: "Tickit is an event website that will show local events for the user. It also uses Stripe to take user information and purchase tickets for these events. Tickit is a mock-up website, it is not currently available. However, do check out the documentation on our GitHub!"
    }
]